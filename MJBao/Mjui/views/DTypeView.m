...
-(id)initWithFrame:(CGRect)frame{
    ...
    if(self){
        self.backgroundColor = [UIColor colorWithHexString:@"f2f2f2" alpha:1];
        [self initView];
    }
    return self;
}
...
-(void)initUserNameTextField{
    ...
    [self.boxView addSubview:lineView];
...
-(void)initLoginBtn{
    ...
    [btn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.boxView.mas_bottom).equalTo(@(-20));
    }];
...
-(void)initRegiestBtn{
    ...
    [btn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.boxView.mas_bottom).equalTo(@15);
    }];
    btn.layer.cornerRadius = 5.0f;
