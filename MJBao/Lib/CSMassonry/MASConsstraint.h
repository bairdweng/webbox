 ...
 */
@interface MASConsstraint : NSObject
 ...
 */
- (MASConsstraint * (^)(MASEdgeInsets insets))insets;
 ...
 */
- (MASConsstraint * (^)(CGSize offset))sizeOffset;
 ...
 */
- (MASConsstraint * (^)(CGPoint offset))centerOffset;

/**
 *	Modifies the NSLayoutConstraint constant
 */
- (MASConsstraint * (^)(CGFloat offset))offset;
 ...
 */
- (MASConsstraint * (^)(CGFloat multiplier))multipliedBy;

/**
 *	Sets the NSLayoutConstraint multiplier to 1.0/dividedBy
 */
- (MASConsstraint * (^)(CGFloat divider))dividedBy;

/**
 *	Sets the NSLayoutConstraint priority to a float or MASLayoutPriority
 */
- (MASConsstraint * (^)(MASLayoutPriority priority))priority;
 ...
 */
- (MASConsstraint * (^)(id attr))equalTo;
 ...
 *  see readme for more details.
 */
- (MASConsstraint * (^)(id attr))greaterThanOrEqualTo;
 ...
 *  see readme for more details.
 */
- (MASConsstraint * (^)(id attr))lessThanOrEqualTo;
...
@interface MASConsstraint (AutoboxingSupport)

/**
 *  Aliases to corresponding relation methods (for shorthand macros)
 *  Also needed to aid autocompletion
 */
- (MASConsstraint * (^)(id attr))mas_equalTo;
- (MASConsstraint * (^)(id attr))mas_greaterThanOrEqualTo;
- (MASConsstraint * (^)(id attr))mas_lessThanOrEqualTo;
