...
@interface SCLAlertsView : UIViewController 
...
@property (strong, nonatomic) UIColor *buttonDefaultColor;
...
@property(copy, nonatomic, readonly) void (^show)(SCLAlertsView *view, UIViewController *controller);
@end
...
@property (strong, nonatomic, readonly) SCLAlertsView *alertView;
